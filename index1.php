...
<!--[if IE 8]>         <html class="no-js lt-ie9"> <![endif]  #CA2128-->
<!--[if gt IE 8]><!-->
<html class="no-js">
    <!--<![endif]-->
        ...
        <div class="boxed-container">
                ...
                <div class="navbar-head">
                    <div class="container">
                        <div class="header-padding" id="shrinkableHeader">
                            <div class="row">
                                <div class="span6">
                                    <a class="brand" href="#" title=""><img src="images/logo_anim_red.gif" alt=""></a>
                                </div>
                                <div class="span6">
            ...
            <div class="fullwidthbanner-container">
                ...
                <div class="parallax-slider">
                    <div class="nav-icons">
                        <a href="#" class="slider-right"> <span class="slider-right-inner"></span> </a>
                        <a href="#" class="slider-pause toogle-pause-resume"> <span class="slider-pause-resume-inner"></span> </a>
                        <a href="#" class="slider-left"> <span class="slider-left-inner"></span> </a>
                        ...
                        <div class="banner">
                            <ul>
                                <li data-transition="fade" data-slotamount="1">
                                    <img src="images/dummy/red/slider/slider_1.jpg" width="2000" height="450" alt="">
                                    ...
                                    <div class="caption sfb fadeout subtitle white"
                                    data-x="0"
                                    data-y="182"
                                    ...
                                    data-speed="600" data-start="1300" data-easing="easeOutBack">
                                        <p>
                                            Sed ut cetero prompta sententiae. Vocibus electram
                                            <br />
                                            te mei, eum eu nibh virtute, iusto delenit albucius ea
                                            <br />
                                            nec. Usu ne noster cetero epicurei.
                                        </p>
                                ...
                                <li data-transition="fade" data-slotamount="1">
                                    <img src="images/dummy/red/slider/slider_2.jpg" width="2000" height="450" alt="">
                    
                                    <div class="caption fade fadeout start"
                                        data-speed="600" data-start="900" data-easing="easeOutExpo"
                                        data-x="283"
                                        data-y="0">
                                    ...
                                    data-speed="600" data-start="1200" data-easing="easeOutBack">
                                        <p>
                                            Vel adi cibon quas aeterno, eani similique intelle gebat
                                            <br />
                                            mea. Sed eunit appetere erroribus, adiu vidie mazim a
                                            <br />
                                            aliquam cum. Ex quo affert maiestati.
                                        </p>
                                    ...
                                    <div class="caption sft fadeout start"
                                        ...
                                        data-x="183"
                                        data-y="0">
                                            <img alt="Image3" src="images/dummy/red/slider/phone.png">
                                    </div>
                                    
                                    <div class="caption sfl fadeout start"
                                        data-speed="400" data-start="1500" data-easing="easeOutBack"
                                        data-x="81"
                                        data-y="97">
                                            <img alt="Image4" src="images/dummy/red/slider/spoon.png">
                                    </div>
                                </li>
            ...
            <div class="container content">
                        ...
                        <div class="carouFredSel" data-nav="latestProj" data-responsive="true">
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="span4">
                                        <div class="thumbnail">
                                            <div class="picture"><img src="images/dummy/red/portfolio/portfolio_3.jpg" alt=""></div>
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Supply Chain Planner</a></h3>
                                                    <p>
                                    ...
                                    <div class="span4">
                                        <div class="thumbnail">
                                            <div class="picture picture-url-overlay">
                                                <div><img src="images/dummy/red/portfolio/portfolio_4.jpg" alt=""> </div>
                                            </div>
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Inventory Management System</a></h3>
                                                    <p>
                                                       Reignsoft Inventory management system provides next generation solution that uses better math and daily granularity to overcome the limitations of traditional inventory optimization tools, which allows you to reduce manual process and save time and money required to control inventory.Inventory management software from Reignsoftprovides Order Management, Asset Tracking, etc. In addition, distributors with multiple branches can transfer items between branches and track item usage at all levels.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="thumbnail-footer">
                                ...
                                <div class="span4">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Demand Planner</a></h3>
                                                    <p>
                                ...
                                <div class="span4">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">ERP</a></h3>
                                                    <p>
                                ...
                                <div class="span4">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Order Management System</a></h3>
                                                    <p>
                            ...
                            <div class="slide">
                                <div class="row">
                                    <div class="span4">
                                        <div class="thumbnail">
                                            <div class="picture">
                                                <a href="images/dummy/red/portfolio/portfolio_2.jpg" class="add-prettyphoto"> <img src="images/dummy/red/portfolio/portfolio_2.jpg" alt=""> <span class="img-overlay"> <span class="plus"><i class="icon-plus"></i></span> </span> </a>
                                            </div>
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Cum ea oblique epicurei scrip</a></h3>
                                                    <p>
                                            ...
                                            <div class="thumbnail-footer">
                                                <div class="pull-left">
                                                    <i class="icon-two-columns"></i><a href="#">Illistration</a> / <a href="#">Design</a>
                                                </div>
                                                <div class="pull-right tablet-bottom">
                                                    104 days ago
                                                </div>
                                    ...
                                    <div class="span4">
                                        <div class="thumbnail">
                                            <div class="picture picture-url-overlay">
                                                <div>
                                                    <img src="images/dummy/red/portfolio/portfolio_1.jpg" alt="">
                                                    <span class="img-overlay url-overlay"> <a href="images/dummy/red/portfolio/portfolio_1.jpg" class="plus add-prettyphoto"><i class="icon-plus"></i></a> <a href="portfolio-single-project.html" class="url"><i class="icon-url"></i></a> </span>
                                                </div>
                                            </div>
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="#">Nemore quodsi dissentias</a></h3>
                                                    <p>
                                            ...
                                            <div class="thumbnail-footer">
                                                <div class="pull-left">
                                                    <i class="icon-two-columns"></i><a href="#">Photography</a> / <a href="#">Web</a>
                                                </div>
                                                <div class="pull-right tablet-bottom">
                                                    139 days ago
                                                </div>
                                    ...
                                    <div class="span4">
                                        <div class="thumbnail">
                                            <div class="picture">
                                                <a href="images/dummy/red/portfolio/portfolio_4.jpg" class="add-prettyphoto"> <img src="images/dummy/red/portfolio/portfolio_4.jpg" alt=""> <span class="img-overlay"> <span class="plus"><i class="icon-plus"></i></span> </span> </a>
                                            </div>
                                            <div class="caption-border-bottom">
                                                <div class="caption  caption-arrow">
                                                    <div class="thumbnail-arrow"></div>
                                                    <h3><a href="portfolio-single-project.html">Etu eum cibo omnis luptatum</a></h3>
                                                    <p>
                                                        Copiosae molestiae sed at, eu quem purtet an perlac, eleifend repreh entie untc sea. Doctus vivendum aten quo mei.
                                                    </p>
                                                </div>
                                            ...
                                            <div class="thumbnail-footer">
                                                <div class="pull-left">
                                                    <i class="icon-two-columns"></i><a href="#">Illistration</a> / <a href="#">Photography</a>
                                                </div>
                                                <div class="pull-right tablet-bottom">
                                                    154 days ago
                                                </div>
                ...
                <div class="row">
                    <div class="span12">
                        <div class="testimonial clearfix">
                            <img src="images/dummy/home/support-red.png" class="pull-right testimonial-img" alt="">
                            <div class="span7">
                                <p>
                                    Vel ad cibo quas aten, eten silue mazim Ut eam autem decore vid, sapientem argumentum eum id, ut omnium officiis <a href="mailto:wballs@support.com">wballs@support.com</a>.
                                </p>
                                <i class="testimonial-name pull-right">- Anna Smith, Cooking Service</i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="span12">
                        <div class="page-header arrow-grey no-bottom-margin no-border">
                            <div class="row">
                                <div class="span6">
                                    <h2>Brands</h2>
                                </div>
                                ...
                                <div class="span6">
                                    <div class="pull-right navs">
                                        <a href="#" id="brandsLeft" class="nav-left"></a><a href="#" id="brandsRight" class="nav-right"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="brands">
                            <div class="carouFredSel" data-nav="brands">
                                <div class="slide">
                                    <a href="#"><img src="images/partners/logo_1.png" alt=""></a>
                                    <a href="#"><img src="images/partners/logo_2.png" alt=""></a>
                                    <a href="#"><img src="images/partners/logo_3.png" alt=""></a>
                                    <a href="#"><img src="images/partners/logo_4.png" alt=""></a>
                                </div>
                                <div class="slide">
                                    <a href="#"><img src="images/partners/logo_3.png" alt=""></a>
                                    <a href="#"><img src="images/partners/logo_1.png" alt=""></a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="span3 foot-item">
                            <h4>Vimeo</h4>
                            <p>
                                <iframe src="http://player.vimeo.com/video/51680122?title=0&amp;byline=0&amp;portrait=0&amp;color=d71402" width="226" height="127" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                            </p>
                            <p>
            ...
            <footer>
                <div class="container">
                    <div class="row">
                        <div class="span4">
                            &copy; 2013 W BALLS - Theme for You
                        </div>
